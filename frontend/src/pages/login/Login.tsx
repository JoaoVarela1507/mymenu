...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      ...
      navigate(authenticatedUser?.type === 'admin' ? '/admin/dashboard' : '/');
    } else {
      ...
      <div className="w-full lg:w-5/12 flex items-center justify-center p-6 bg-gradient-to-b from-gray-50 to-gray-100 overflow-y-auto relative z-10">
        <div className="glass-card-golden w-full max-w-lg shadow-2xl">
          ...
          <div className="text-center mt-1.5 pt-1 border-t border-[#D4AF37]/30">
            ...
            <Link
              to="/cadastro"
              style={{ backgroundColor: '#FFF8E7', color: '#C92924' }}
              className="inline-block w-full border-2 border-gray-300 font-bold text-xs py-2 px-4 rounded-lg hover:border-[#D4AF37] transition-colors mt-2"
            >
              Fazer cadastro
            </Link>
          </div>
